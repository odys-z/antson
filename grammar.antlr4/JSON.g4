 ...
 *
 * java -jar ~/antlr4/antlr-[###]-complete.jar JSON.g4 -package gen.antlr.json
 *
 * java -jar ~/antlr4/antlr-[###]-complete.jar JSON.g4 -Dlanguage=python3
 ...
 * java -jar ~/progs/antlr4/antlr-[###]-complete.jar JSON.g4 -Dlanguage=CSharp
 */
