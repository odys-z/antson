...
class JSONListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by JSONParser#type.
    def enterType(self, ctx:JSONParser.TypeContext):
        pass

    # Exit a parse tree produced by JSONParser#type.
    def exitType(self, ctx:JSONParser.TypeContext):
        pass
